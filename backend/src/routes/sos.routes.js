...
router.post(
  ...
  asyncHandler(sosController.triggerSOS),
);
...
router.post(
  ...
  asyncHandler(sosController.cancelSOS),
);
 ...
 *         description: Unauthorized
 */
router.get("/history", authenticate, asyncHandler(sosController.getHistory));
...
router.get(
  "/history/:alertId",
  authenticate,
  asyncHandler(sosController.getHistoryEntry),
);
...
router.get(
  "/status/:alertId",
  authenticate,
  asyncHandler(sosController.getStatus),
);
