    ...
    <>
      ...
      <div className={cn("flex-1 flex flex-col justify-around", className)}>
        <div className="space-y-8 flex flex-col items-center text-center">
          <div className="bg-brand-50 rounded-full w-30 h-30 text-primary flex justify-center items-center">
        ...
        <BareBoneFooter cta={cta} to={to} resend={resend} changeEmail={changeEmail} />
      </div>
    </>
  )
}
